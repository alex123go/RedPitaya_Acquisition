...
# Modification of JD's code. This version don't allow reconnection
...
class initialConfiguration(QtWidgets.QDialog):
	...
	def __init__(self, dev, devices_data={}, strBroadcastAddress="192.168.0.255", strFPGAFirmware='', strCPUFirmware=''):
...
#        print 'after check_answers'
	...
	def initUI(self):
		...
		# self.qradio_noreprogram.setChecked(True)
		
		# self.qgroupbox_connection = Qt.QGroupBox()
		# gridConnection = Qt.QGridLayout()
		
		# gridConnection.addWidget(self.qradio_reprogram,		0, 0)
		# gridConnection.addWidget(self.qradio_noreprogram, 	0, 1)
		...
		# grid.addWidget(self.qgroupbox_connection, 5, 0, 1, 2)
...
#            print self.qcombo_serial.minimumSizeHint()
	...
	def okClicked(self):
		...
		# if self.qradio_noreprogram.isChecked():
		# 	self.reprogram = False
		# else:
		# 	self.reprogram = True
...
#	initialConfiguration(self.dev, devices_data=devices_data, strFPGAFirmware=strFPGAFirmware, strCPUFirmware=strCPUFirmware)
