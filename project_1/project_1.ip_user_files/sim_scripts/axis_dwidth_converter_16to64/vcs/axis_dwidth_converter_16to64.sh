...
# executing this script. Please type 'axis_dwidth_converter_16to64.sh -help' for more information.
#
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"D:/Programs/Vivado/2019.1/data/xilinx_vip/include" \
    "$ref_dir/../../../ip/axis_dwidth_converter_16to64/sim/axis_dwidth_converter_16to64.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_dwidth_converter_16to64 xil_defaultlib.glbl -o axis_dwidth_converter_16to64_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_dwidth_converter_16to64_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axis_dwidth_converter_16to64_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc axis_dwidth_converter_16to64_simv.daidir)
