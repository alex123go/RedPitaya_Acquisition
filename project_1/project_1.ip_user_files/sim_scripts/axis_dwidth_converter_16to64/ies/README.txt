...
#
# Generated by export_simulation on Tue Apr 14 18:13:56 -0400 2020
#
################################################################################
...
./axis_dwidth_converter_16to64.sh
...
'-reset_run' switch to the './axis_dwidth_converter_16to64.sh' script.

./axis_dwidth_converter_16to64.sh -reset_run
...
./axis_dwidth_converter_16to64.sh -noclean_files

For more information on the script, please type './axis_dwidth_converter_16to64.sh -help'.
