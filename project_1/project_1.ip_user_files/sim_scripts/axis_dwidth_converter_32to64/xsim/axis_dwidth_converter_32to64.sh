...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axis_infrastructure_v1_1_0 -L axis_register_slice_v1_1_19 -L axis_dwidth_converter_v1_1_18 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_dwidth_converter_32to64 xil_defaultlib.axis_dwidth_converter_32to64 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_dwidth_converter_32to64 -key {Behavioral:sim_1:Functional:axis_dwidth_converter_32to64} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_dwidth_converter_32to64.wdb xsim.dir)
